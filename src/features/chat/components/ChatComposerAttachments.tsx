      ...
      {attachedImages.map((img, index) => (
        <div key={`img-${index}`} className="group relative">
          <button
            ...
            className="block rounded-lg outline-none transition-transform hover:scale-[1.01] focus-visible:ring-2 focus-visible:ring-[var(--foreground)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--background)]"
