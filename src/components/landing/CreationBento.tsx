    ...
    >
      ...
      <div className="grid w-full max-w-4xl grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        >
          ...
          <div className="relative h-32 overflow-hidden rounded-xl bg-zinc-950">
            <div className="absolute inset-y-0 left-0 right-0 flex items-center justify-center gap-1 px-2">
              {[...Array(7)].map((_, i) => (
                <motion.div
                  key={i}
                  className="h-20 flex-1 rounded bg-zinc-700"
        ...
        >
          ...
          {/* Waveform animation */}
          <div className="flex h-32 items-center justify-center gap-1 rounded-xl bg-gradient-to-r from-sky-500/20 to-indigo-500/20">
        ...
        >
          ...
          {/* Typing animation */}
          <div className="h-32 overflow-hidden rounded-xl p-4">
            <div className="flex flex-col gap-2">
              ...
              <motion.span
                ...
                className={`h-3.5 w-0.5 rounded-full ${isDark ? "bg-zinc-300" : "bg-zinc-700"}`}
              />
            </div>
          </div>
        </motion.div>
