  ...
  if (mode === 'act') {
    ...
    tools.run_daytona_sandbox = tool({
      description:
        ...
        'Use this for programmatic workflows like app building, code generation, file transforms, slideshow generation, or media pipelines that should run through command-line tooling rather than browser automation or an Overlay computer. ' +
