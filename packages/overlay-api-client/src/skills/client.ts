...
export class SkillsClient {
  ...
  private path(query?: SkillQuery): string {
    return this.http.appendQuery('/api/app/skills', query as QueryParams | undefined)
  }
  ...
  create(body: CreateSkillRequest, init?: RequestInit) {
    return this.http.json<CreateEntityResponse>('/api/app/skills', this.http.jsonRequest(body, { ...init, method: 'POST' }))
  }

  createResponse(body: CreateSkillRequest, init?: RequestInit) {
    return this.http.request('/api/app/skills', this.http.jsonRequest(body, { ...init, method: 'POST' }))
  }
  ...
  updateResponse(body: UpdateSkillRequest, init?: RequestInit) {
    return this.http.request('/api/app/skills', this.http.jsonRequest(body, { ...init, method: 'PATCH' }))
  }
