...
import { ArrowLeft, BookOpen, ChevronDown, ChevronRight, FileText, Folder, FolderOpen, FolderPlus, Loader2, MessageSquare, Pencil, Plus, Settings, Trash2, Upload } from 'lucide-react'
import type {
  ConversationSummary,
  KnowledgeFile,
  NoteDoc,
